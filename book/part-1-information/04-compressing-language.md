...
carries a lot of information and must be preserved. It's tempting to
picture this the way you'd picture compressing a photo — a blurry,
lower-resolution version that has genuinely lost detail. Language
compression doesn't work that way: good compression specifically targets
redundant, predictable content, the exact opposite of the parts of a
message that carry meaning. Removing the words "I will be" from "I will be
arriving Tuesday" loses nothing a reader couldn't reconstruct — unlike
smudging out a photo's details, which are never recoverable. What's left,
after compression, is precisely the informative core of the message.
...
meaning. It's tempting to think of "context" as just a vague label for "the
general topic" being discussed — but that's a much looser idea than what's
meant here. Context, in this technical sense, is the specific sequence of
surrounding tokens, and it can resolve very fine-grained ambiguity, not
just topic. Knowing the "topic" of a conversation is a river doesn't tell
you nearly as much as knowing the exact previous sentence, which is what
actually tells you whether "bank" means the water's edge or the building
down the street.
